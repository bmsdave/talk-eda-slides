...
var mo = createCommonjsModule(function (module, exports) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	// istanbul ignore next
	if ((  (0, _typeof3.default)(module)) === "object" && (0, _typeof3.default)(module.exports) === "object") {
	  module.exports = mojs;
	}
...
const COLORS = {
  ...
  const bgBurst = new mojs$1.Burst({
    left: 0, top: 0,
    count:  3,
    radius: 0,
    degree: 0,
  ...
  const circle1 = new mojs$1.Shape({
      ...CIRCLE_OPTS,
      radius:   200,
    });
  
  const circle2 = new mojs$1.Shape({
    ...CIRCLE_OPTS,
    radius:   240,
    easing: 'cubic.out',
    delay: 150,
