...
(function( root, factory ) {
	...
	function onDocumentKeyDown( event ) {
		...
		var firstSlideShortcut = ( event.metaKey || event.ctrlKey ) && keyCode === 33 /* 37 */;
		var lastSlideShortcut = ( event.metaKey || event.ctrlKey ) && keyCode === 34 /* 39 */;
		...
		if( triggered === false ) {
			...
			// P, PAGE UP
			if( keyCode === 80 || keyCode === 37 /* 33 */ ) {
				navigatePrev();
			}
			// N, PAGE DOWN
			else if( keyCode === 78 || keyCode === 39 /* 34 */ ) {
				navigateNext();
			}
			// H, LEFT
			else if( keyCode === 72 || keyCode === 33 /* 37 */ ) {
			...
			// L, RIGHT
			else if( keyCode === 76 || keyCode === 34 /* 39 */ ) {
